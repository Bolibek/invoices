...
import FormInput from '../components/FormInputs/FormInput.jsx'
...
export default function SignUp() {
  ...
  return (
    <div className="font-mono mt-5 container mx-auto flex justify-center px-6 flex-col w-full lg:w-7/12 bg-[#ffffff] p-5 rounded-lg lg:rounded-l-none">
